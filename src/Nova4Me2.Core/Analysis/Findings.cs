...
public sealed class Finding
{
    ...
    public bool IsFixableHere => Repair is RepairKind.RestoreBootSectorFromBackup or RepairKind.RestoreBackupBootSectorFromPrimary or RepairKind.RestoreGptFromBackup or RepairKind.RestoreMftFromMirror;
